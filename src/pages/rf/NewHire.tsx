...
export default function NewHire() {
    ...
    const validateStep = (stepIndex: number) => {
        ...
        if (stepIndex === 1) {
            return formData.pvzId && formData.baseRate && formData.iban.length >= 16;
        }
        ...
        return (
            <div className="flex h-full flex-col bg-background/50">
                <PageHeader
                    ...
                    breadcrumbs={[{ label: "Мой ПВЗ", path: "/rf" }, { label: "Новый сотрудник" }]}
                />
                <div className="flex-1 flex items-center justify-center p-6">
                    <div className="max-w-md w-full rounded-2xl border bg-card p-8 text-center shadow-lg">
                        ...
                        <h2 className="text-2xl font-bold mb-3">Заявка успешно отправлена!</h2>
                        ...
                        <div className="p-8">
                            ...
                            {currentStep === 0 && (
                                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    <div className="mb-6">
                                        ...
                                        <p className="text-sm text-muted-foreground mt-1">Основная информация о кандидате</p>
                                    </div>
                            ...
                            {currentStep === 1 && (
                                <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                                    ...
                                    <div className="grid gap-6 md:grid-cols-2">
                                        <div className="space-y-2">
                                            <label className="text-sm font-semibold">Пункт выдачи (ПВЗ) <span className="text-destructive">*</span></label>
                                            <select
                                                required
                                                name="pvzId"
                                                ...
                                                className="w-full rounded-lg border bg-background px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50"
                                            >
                                                <option value="" disabled>Обязательно выберите ПВЗ...</option>
                                                {pvzList.map(pvz => (
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-sm font-semibold">IBAN Счет <span className="text-destructive">*</span></label>
                                            <input
                                                required
                                                name="iban"
                                                value={formData.iban}
                                                ...
                                                placeholder="KZ..."
                                            />
                                            <div className="flex items-center gap-1.5 mt-1.5 text-xs font-medium text-amber-600">
